...
class MLPCA:
    """Maximum-likelihood PCA estimator — stub for Task 4."""

    def __init__(self, n_components=None, max_iter=100, tol=1e-3):
        self.n_components = n_components
        self.max_iter = max_iter
        self.tol = tol

    def fit(self, X, variance=None):
        raise NotImplementedError("Refactor in task 4")

    def transform(self, X):
        raise NotImplementedError("Refactor in task 4")

    def fit_transform(self, X, variance=None):
        raise NotImplementedError("Refactor in task 4")
